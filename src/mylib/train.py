...
class Trainer(object):
    ...
    def eval(self, output_dict=False):
        ...
        return classification_report(
            self.Y_val, self.model.predict(self.X_val), output_dict=output_dict
        )
    ...
    def test(self, X, Y, output_dict=False):
        ...
        :type Y: numpy.array
        """
        return classification_report(Y, self.model.predict(X), output_dict=output_dict)
