...
Bensemble allows you to understand **why** your model is uncertain by decomposing the total predictive variance/entropy into two components:
...
### How to compute
Simply pass your ensemble's predictions to our decomposition functions:
```python
